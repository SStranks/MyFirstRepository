...
function momentOfTimeInSpace(moment) {
  let pos = moment.match(/[1-9]/g) || [];
  const neg = 8 - pos.length;
  pos = pos.reduce((acc, cur) => acc + Number(cur), 0);
  return neg > pos ? [true, false, false] : pos > neg ? [false, false, true] : [false, true, false];
}
