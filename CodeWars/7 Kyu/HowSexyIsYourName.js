...
function sexyName(name) {
  const score = [...name.toUpperCase()].reduce((acc, cur) => acc + (SCORES[cur] || 0), 0)
  switch (true) {
    case (score <= 60): return "NOT TOO SEXY"
    case (score <= 300): return "PRETTY SEXY"
    case (score <= 599): return "VERY SEXY"
    case (score >= 600): return "THE ULTIMATE SEXIEST"
  }
}