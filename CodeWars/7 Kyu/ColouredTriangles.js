...
function triangle(row){
  let colours = row.split("");
  while (colours.length > 1){
    colours = colours.map(function(el, i){
      if (el === colours[i + 1]) return el
      if ((el === "B" && colours[i + 1] === "G") || (el === "G" && colours[i + 1] === "B")) return "R";
      if ((el === "R" && colours[i + 1] === "G") || (el === "G" && colours[i + 1] === "R")) return "B";
      if ((el === "B" && colours[i + 1] === "R") || (el === "R" && colours[i + 1] === "B")) return "G";
    })
